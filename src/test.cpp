...
// Regenerated after wire-sysio PR #288 widened table_def.name from sysio::name
// (uint64) to std::string and added table_id + secondary_indexes. The on-wire
// table layout is now [varint name len][name bytes][index_type ...][...][type
// ...][uint16 table_id][secondary_indexes count + entries]. Generated by
// /tmp/regen_token_hex from the canonical token ABI JSON.
