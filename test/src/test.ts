...
function check_types() {
    ...
    check_type(0, js2Types, 'public_key', '"SYS1111111111111111111111111111111114T1Anm"', '"PUB_K1_11111111111111111111111111111111149Mr2R"');
    check_type(0, js2Types, 'public_key', '"SYS11111111111111111111111115qCHTcgbQwptSz99m"', '"PUB_K1_11111111111111111111111115qCHTcgbQwpvP72Uq"');
    check_type(0, js2Types, 'public_key', '"SYS111111111111111114ZrjxJnU1LA5xSyrWMNuXTrYSJ57"', '"PUB_K1_111111111111111114ZrjxJnU1LA5xSyrWMNuXTrVub2r"');
    check_type(0, js2Types, 'public_key', '"SYS1111111113diW7pnisfdBvHTXP7wvW5k5Ky1e5DVuF23dosU"', '"PUB_K1_1111111113diW7pnisfdBvHTXP7wvW5k5Ky1e5DVuF4PizpM"');
    check_type(0, js2Types, 'public_key', '"SYS11DsZ6Lyr1aXpm9aBqqgV4iFJpNbSw5eE9LLTwNAxqjJgmjgbT"', '"PUB_K1_11DsZ6Lyr1aXpm9aBqqgV4iFJpNbSw5eE9LLTwNAxqjJgXSdB8"');
    check_type(0, js2Types, 'public_key', '"SYS12wkBET2rRgE8pahuaczxKbmv7ciehqsne57F9gtzf1PVYNMRa2"', '"PUB_K1_12wkBET2rRgE8pahuaczxKbmv7ciehqsne57F9gtzf1PVb7Rf7o"');
    check_type(0, js2Types, 'public_key', '"SYS1yp8ebBuKZ13orqUrZsGsP49e6K3ThVK1nLutxSyU5j9SaXz9a"', '"PUB_K1_1yp8ebBuKZ13orqUrZsGsP49e6K3ThVK1nLutxSyU5j9Tx1r96"');
    check_type(0, js2Types, 'public_key', '"SYS9adaAMuB9v8yX1mZ5PtoB6VFSCeqRGjASd8ZTM6VUkiHL7mue4K"', '"PUB_K1_9adaAMuB9v8yX1mZ5PtoB6VFSCeqRGjASd8ZTM6VUkiHLB5XEdw"');
    check_type(0, js2Types, 'public_key', '"SYS69X3383RzBZj41k73CSjUNXM5MYGpnDxyPnWUKPEtYQmTBWz4D"', '"PUB_K1_69X3383RzBZj41k73CSjUNXM5MYGpnDxyPnWUKPEtYQmVzqTY7"');
    check_type(0, js2Types, 'public_key', '"SYS7yBtksm8Kkg85r4in4uCbfN77uRwe82apM8jjbhFVDgEgz3w8S"', '"PUB_K1_7yBtksm8Kkg85r4in4uCbfN77uRwe82apM8jjbhFVDgEcarGb8"');
    check_type(0, js2Types, 'public_key', '"SYS7WnhaKwHpbSidYuh2DF1qAExTRUtPEdZCaZqt75cKcixuQUtdA"', '"PUB_K1_7WnhaKwHpbSidYuh2DF1qAExTRUtPEdZCaZqt75cKcixtU7gEn"');
    check_type(0, js2Types, 'public_key', '"SYS7Bn1YDeZ18w2N9DU4KAJxZDt6hk3L7eUwFRAc1hb5bp6xJwxNV"', '"PUB_K1_7Bn1YDeZ18w2N9DU4KAJxZDt6hk3L7eUwFRAc1hb5bp6uEBZA8"');
...
async function push_transfer() {
    if (useTokenHexApi)
        check(l.abieos_set_abi_hex(context, name('sysio.token'), cstr(tokenHexApi)));
    else
        check(l.abieos_set_abi(context, name('sysio.token'), jsonStr((await rpc.get_abi('sysio.token')).abi)));
    let type = checkPtr(l.abieos_get_type_for_action(context, name('sysio.token'), name('transfer')));
    check(l.abieos_json_to_bin(context, name('sysio.token'), type, jsonStr({
        from: 'useraaaaaaaa',
        to: 'useraaaaaaab',
        quantity: '0.0001 SYS',
        memo: '',
    ...
    console.log('action bin->json: ', abieos_hex_to_json(name('sysio.token'), 'transfer', actionDataHex));
