...
#   pragma clang diagnostic pop
   ...
   SYSIO_REFLECT(extension, type, data)
   ...
   SYSIO_REFLECT(get_status_request_v0)

   struct get_status_request_v1 {};

   SYSIO_REFLECT(get_status_request_v1)
   ...
   SYSIO_REFLECT(block_position, block_num, block_id)
   ...
   SYSIO_REFLECT(get_status_result_base, head, last_irreversible, trace_begin_block, trace_end_block,
                 chain_state_begin_block, chain_state_end_block)

   struct get_status_result_v0 : get_status_result_base {
      might_not_exist<sysio::checksum256> chain_id;
   };

   SYSIO_REFLECT(get_status_result_v0, base get_status_result_base, chain_id)
   ...
   SYSIO_REFLECT(get_status_result_v1, base get_status_result_base, chain_id, finality_data_begin_block, finality_data_end_block)
   ...
   SYSIO_REFLECT(get_blocks_request_v0, start_block_num, end_block_num, max_messages_in_flight, have_positions,
   ...
   SYSIO_REFLECT(get_blocks_request_v1, base get_blocks_request_v1, fetch_finality_data)

   struct get_blocks_ack_request_v0 {
      uint32_t num_messages = {};
   };

   SYSIO_REFLECT(get_blocks_ack_request_v0, num_messages)
   ...
   SYSIO_REFLECT(get_blocks_result_base, head, last_irreversible, this_block, prev_block)
   ...
   SYSIO_REFLECT(get_blocks_result_v0, base get_blocks_result_base, block, traces, deltas)

   struct get_blocks_result_v1 : get_blocks_result_v0 {
      std::optional<sysio::input_stream> finality_data = {};
   };

   SYSIO_REFLECT(get_blocks_result_v1, base get_blocks_result_v0, finality_data)
   ...
   SYSIO_REFLECT(row_v0, present, data)
   ...
   SYSIO_REFLECT(table_delta_v0, name, rows)
   ...
   SYSIO_REFLECT(permission_level, actor, permission)
   ...
   SYSIO_REFLECT(action, account, name, authorization, data)
   ...
   SYSIO_REFLECT(account_auth_sequence, account, sequence)
   SYSIO_COMPARE(account_auth_sequence);
   ...
   SYSIO_REFLECT(action_receipt_v0, receiver, act_digest, global_sequence, recv_sequence, auth_sequence, code_sequence,
                 abi_sequence)
   ...
   SYSIO_REFLECT(account_delta, account, delta)
   SYSIO_COMPARE(account_delta);
   ...
   SYSIO_REFLECT(action_trace_v0, action_ordinal, creator_action_ordinal, receipt, receiver, act, context_free, elapsed,
   ...
   SYSIO_REFLECT(action_trace_v1, action_ordinal, creator_action_ordinal, receipt, receiver, act, context_free, elapsed,
   ...
   SYSIO_REFLECT(partial_transaction_v0, expiration, ref_block_num, ref_block_prefix, max_net_usage_words,
   ...
   SYSIO_REFLECT(transaction_trace_v0, id, status, cpu_usage_us, net_usage_words, elapsed, net_usage, scheduled,
   ...
   SYSIO_REFLECT(producer_key, producer_name, block_signing_key)
   ...
   SYSIO_REFLECT(transaction_header, expiration, ref_block_num, ref_block_prefix, max_net_usage_words, max_cpu_usage_ms,
                 delay_sec)
   ...
   SYSIO_REFLECT(transaction, base transaction_header, context_free_actions, actions, transaction_extensions)
   ...
   SYSIO_REFLECT(code_id, vm_type, vm_version, code_hash)
   ...
   SYSIO_REFLECT(account_v0, name, creation_date, abi)
   ...
   SYSIO_REFLECT(account_metadata_v0, name, privileged, last_code_update, code)
   ...
   SYSIO_REFLECT(code_v0, vm_type, vm_version, code_hash, code)
   ...
   SYSIO_REFLECT(contract_table_v0, code, scope, table, payer)
   ...
   SYSIO_REFLECT(contract_row_v0, code, scope, table, primary_key, payer, value)
   ...
   SYSIO_REFLECT(contract_index64_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   SYSIO_REFLECT(contract_index128_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   SYSIO_REFLECT(contract_index256_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   SYSIO_REFLECT(contract_index_double_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   SYSIO_REFLECT(contract_index_long_double_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   SYSIO_REFLECT(key_weight, key, weight)
   ...
   SYSIO_REFLECT(block_signing_authority_v0, threshold, keys)
   ...
   SYSIO_REFLECT(producer_authority, producer_name, authority)
   ...
   SYSIO_REFLECT(producer_authority_schedule, version, producers)
   ...
   SYSIO_REFLECT(wasm_config_v0, max_mutable_global_bytes, max_table_elements, max_section_elements,
   ...
   SYSIO_REFLECT(global_property_v0, proposed_schedule_block_num, proposed_schedule, configuration)
   ...
   SYSIO_REFLECT(global_property_v1, proposed_schedule_block_num, proposed_schedule, configuration, chain_id, wasm_configuration)
   ...
   SYSIO_REFLECT(generated_transaction_v0, sender, sender_id, payer, trx_id, packed_trx)
   ...
   SYSIO_REFLECT(activated_protocol_feature_v0, feature_digest, activation_block_num)
   ...
   SYSIO_REFLECT(protocol_state_v0, activated_protocol_features)
   ...
   SYSIO_REFLECT(permission_level_weight, permission, weight)
   ...
   SYSIO_REFLECT(wait_weight, wait_sec, weight)
   ...
   SYSIO_REFLECT(authority, threshold, keys, accounts, waits)
   ...
   SYSIO_REFLECT(permission_v0, owner, name, parent, last_updated, auth)
   ...
   SYSIO_REFLECT(permission_link_v0, account, code, message_type, required_permission)
   ...
   SYSIO_REFLECT(resource_limits_v0, owner, net_weight, cpu_weight, ram_bytes)
   ...
   SYSIO_REFLECT(usage_accumulator_v0, last_ordinal, value_ex, consumed)
   ...
   SYSIO_REFLECT(resource_usage_v0, owner, net_usage, cpu_usage, ram_usage)
   ...
   SYSIO_REFLECT(resource_limits_state_v0, average_block_net_usage, average_block_cpu_usage, total_net_weight,
   ...
   SYSIO_REFLECT(resource_limits_ratio_v0, numerator, denominator)
   ...
   SYSIO_REFLECT(elastic_limit_parameters_v0, target, max, periods, max_multiplier, contract_rate, expand_rate)
   ...
   SYSIO_REFLECT(resource_limits_config_v0, cpu_limit_parameters, net_limit_parameters,
   ...
   SYSIO_REFLECT(finalizer_authority, description, weight, public_key)
   ...
   SYSIO_REFLECT(finalizer_authority_with_string_key, description, weight, public_key)
   ...
   SYSIO_REFLECT(finalizer_policy_with_string_key, generation, threshold, finalizers)
   ...
   struct finality_data {
      ...
      sysio::checksum256              reversible_blocks_mroot            = {};
      uint32_t                        latest_qc_claim_block_num          = {};
      sysio::checksum256              latest_qc_claim_finality_digest    = {};
      sysio::block_timestamp          latest_qc_claim_timestamp          = {};
      sysio::checksum256              base_digest                        = {};
      std::optional<finalizer_policy_with_string_key> pending_finalizer_policy = {};
      uint32_t                        last_pending_finalizer_policy_generation = {};
   };

   SYSIO_REFLECT(finality_data, major_version, minor_version, active_finalizer_policy_generation,
   ...
   struct protocol_feature_activation_extension {
      std::vector<sysio::checksum256> protocol_features = {};
   };

   SYSIO_REFLECT(protocol_feature_activation_extension, protocol_features)
